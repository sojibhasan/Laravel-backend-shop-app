...
return [
    ...
    'attributes' => [
        ...
        "status"            => 'Status',
        "note"              => 'catatan',
        "available_date"    => 'Tersedia untuk pengiriman dari tanggal',
        "serial"            => 'Serial',
        "phone_company"     => 'telepon perusahaan',
        "name_company"      => 'Nama Perusahaan',
        "address_company"   => 'Alamat perusahaan',
        "phone2_company"    => 'Ponsel kedua perusahaan',
        "phone_customer"    => 'Nomor pelanggan',
        "name_customer"     => 'Nama Pelanggan',
        "address_customer"  => 'alamat pelanggan',
        "phone2_customer"   => 'Telepon kedua pelanggan',
        'oldPassword'       => 'Password lama',
        'newPassword'       => 'Kata sandi baru',
        'name_ar'           => 'Nama dalam Bahasa Arab',
        'name_en'           => 'Nama dalam bahasa Inggris',
        'description_ar'    => 'Deskripsi dalam bahasa Arab',
        'description_en'    => 'Deskripsi dalam bahasa Inggris',
        'quantity'          => 'Kuantitas',
        'regular_price'     => 'harga produk',
        'sale_price'        => 'harga Diskon',
        'start_sale'        => 'Tanggal mulai diskon',
        'end_sale'          => 'tanggal akhir diskon',
        'categories'        => 'Kategori',
        'images'            => 'Foto-foto',
        'img'               => 'Gambar',
        'statements'        => 'fitur',
