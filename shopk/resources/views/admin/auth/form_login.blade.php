<form class="text-left" method="post" action="{{route('admin.login')}}">
    ...
    <div class="form">
        ...
        <div id="email-field" class="field-wrapper input">
            ...
            <input id="email" name="email" type="email"  class="@error('email') is-invalid @enderror form-control" maxlength="100" required placeholder="Email" >
        ...
        <div id="password-field" class="field-wrapper input mb-2">
            ...
            <input id="password" name="password" type="password" class="@error('password') is-invalid @enderror form-control" maxlength="255"  placeholder="Password" >
