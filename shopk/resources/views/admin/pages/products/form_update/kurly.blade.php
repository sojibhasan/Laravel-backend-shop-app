...
{{--    ///////////////////////// start clone /////////////////////////////--}}
    <div class="cover-kurly clone d-none bg-light pt-3 pb-3 mb-4 row">
        ...
        <div class="col-md-5">
            <input maxlength="50" required name="kurly[0][value_ar]" type="text" class="value_ar form-control" placeholder="@lang('form.label.value ar')" value="">
        </div>
        <div class="col-md-5">
        ...
        <div class="col-md-5">
            <input maxlength="50" required name="kurly[0][value_en]" type="text" class="value_en form-control" placeholder="@lang('form.label.value en')" value="">
        </div>
        <div class="col-md-2">
    ...
    @if(is_array($kurly))
        ...
        @foreach($kurly as $kurlyLoop)
            <div class="cover-kurly bg-light pt-3 pb-3 mb-4 row">
                ...
                <div class="col-md-5">
                    <input maxlength="50" required name="kurly[{{$loop->index}}][value_ar]" type="text" class="value_ar form-control @error("kurly.$loop->index.value_ar") is-invalid @enderror" value="{{$kurlyLoop['value_ar']}}" placeholder="القيمة باللغة العربية">
                ...
                <div class="col-md-5">
                    <input maxlength="50" required name="kurly[{{$loop->index}}][value_en]" type="text" class="value_en form-control @error("kurly.$loop->index.value_en") is-invalid @enderror" value="{{$kurlyLoop['value_en']}}" placeholder="القيمة باللغة الانجليزية">
