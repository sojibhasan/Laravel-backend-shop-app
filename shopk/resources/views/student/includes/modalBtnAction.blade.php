    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalActionLabel">تعديل البيانات</h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary modal-close" data-dismiss="modal">اغلاق</button>
                <a href="" class="btn btn-success btnUpdate">تحديث البيانات</a>
            </div>
            <div class="message">
